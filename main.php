        ...
        <thead>
          <tr>
            ...
            <?php if (!$scp->getAdmin()->isAllView) : ?><th><?php echo SCP_DAILYREPORT; ?></td><?php endif; ?>
              <?php if (!$scp->getAdmin()->isAllView) : ?>
              <th><a href="http://www.haggybear.de/download/scp-remote-example.zip" alt="<?php echo SCP_REMOTE_ACCESS_EXAMPLE; ?>" title="<?php echo SCP_REMOTE_ACCESS_EXAMPLE; ?>"><?php echo SCP_REMOTE_ACCESS; ?></a></td><?php endif; ?>
          </tr>
        </thead>
        <tbody>
          <tr valign="middle">
  ...
  <form name="setlists" method="post" action="index.php?<?php $scp->getQueryString(); ?><?php echo ($scp->getAdmin()->isAllView) ? "&action=allview" : ""; ?>">
    <table width="640" border="0" cellspacing="0" cellpadding="0" height="480">
      ...
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
        <td height="75" colspan="2" align="left" valign="top" class="rand"><?php echo SCP_EXPLAIN_IP; ?><p style="margin-top:15px;text-align:center" class="fatred"><?php echo SCP_EXPLAIN_EXPIRES; ?></p><br>
          <div class="caldiv" style="display:none;position:absolute;width:95%"></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
...
<div id="rdnslists" class="invis">
  <form name="setlists" method="post" action="index.php?<?php $scp->getQueryString(); ?><?php echo ($scp->getAdmin()->isAllView) ? "&action=allview" : ""; ?>">
    <table width="640" border="0" cellspacing="0" cellpadding="0" height="480">
      ...
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
        <td height="75" colspan="2" align="left" valign="top" class="rand"><?php echo SCP_EXPLAIN_RDNS; ?><p style="margin-top:15px;text-align:center" class="fatred"><?php echo SCP_EXPLAIN_EXPIRES; ?></p><br>
          <div class="caldiv" style="display:none;position:absolute;width:95%"></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
...
<div id="senderlists" class="invis">
  <form name="setlists" method="post" action="index.php?<?php $scp->getQueryString(); ?><?php echo ($scp->getAdmin()->isAllView) ? "&action=allview" : ""; ?>">
    <table width="640" border="0" cellspacing="0" cellpadding="0" height="480">
      ...
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
        <td height="75" colspan="2" align="left" valign="top" class="rand"><?php echo SCP_EXPLAIN_SENDER; ?><p style="margin-top:15px;text-align:center" class="fatred"><?php echo SCP_EXPLAIN_EXPIRES; ?></p><br>
          <div class="caldiv" style="display:none;position:absolute;width:95%"></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
...
<div id="headerlists" class="invis">
  <form name="setlists" method="post" action="index.php?<?php $scp->getQueryString(); ?><?php echo ($scp->getAdmin()->isAllView) ? "&action=allview" : ""; ?>">
    <table width="320" border="0" cellspacing="0" cellpadding="0" height="480">
      ...
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
        <td height="45" align="left" valign="top" class="rand"><?php echo SCP_EXPLAIN_HEADER; ?><p style="margin-top:15px;text-align:center" class="fatred"><?php echo SCP_EXPLAIN_EXPIRES; ?></p><br>
          <div class="caldiv" style="display:none;position:absolute;width:95%"></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
...
<div id="keywordlists" class="invis">
  <form name="setlists" method="post" action="index.php?<?php $scp->getQueryString(); ?><?php echo ($scp->getAdmin()->isAllView) ? "&action=allview" : ""; ?>">
    <table width="320" border="0" cellspacing="0" cellpadding="0" height="480">
      ...
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
        <td height="75" align="left" valign="top" class="rand"><?php echo SCP_EXPLAIN_KEYWORDS; ?><p style="margin-top:15px;text-align:center" class="fatred"><?php echo SCP_EXPLAIN_EXPIRES; ?></p><br>
          <div class="caldiv" style="display:none;position:absolute;width:95%"></div>
        </td>
      </tr>
      <tr bgcolor="#FFFFFF" align="center" valign="middle">
...
<div id="iplook" class="invis">
  <table width="640" border="0" cellspacing="0" cellpadding="0" height="480">
    ...
    <tr bgcolor="#FFFFFF" align="center" valign="middle">
      <td height="460" align="left" valign="top" class="rand">
        <div id="iplook_content"></div>
      </td>
    </tr>
  </table>
</div>
